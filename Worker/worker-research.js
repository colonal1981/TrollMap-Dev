...
export { handleResearchThermoclineSearch, handleResearchList, handleResearchGet, handleResearchSave, handleResearchDelete, handleEnhancedLakeIntel } from './research/storage.js';
...
export { handleResearchDeterministicFacts, handleResearchSaveNormalized, handleResearchGetNormalized, registrySpeciesFor, speciesFoodHabits, speciesMeasuredTraits } from './research/deterministic.js';
export { handleResearchAnalyzeFacts, handleResearchMapFacts, handleResearchGapAnalysis, handleResearchGapSearch, GAP_QUERIES } from './research/extract.js';
...
export { handleSharedPublish, handleSharedStatus, handleSharedQuarantine, handleResearchRegsDebug } from './research/shared.js';
