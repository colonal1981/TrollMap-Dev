...
A-Rig Light (~1.65oz), A-Rig Medium (~2.65oz), A-Rig Heavy (~3.5oz), Squarebill Crankbait, SR Crankbait (3-5ft), MR Crankbait (6-12ft), DD1 Crankbait (14-18ft), DD2 Crankbait (16-20ft), DD3 Crankbait (20-25ft), DD4 Crankbait (25ft+), 2" Lipless Crankbait, 3" Lipless Crankbait, 4" Lipless Crankbait, 3" Blade Vibe Bait, 3" Paddle Tail Swimbait, 4" Paddle Tail Swimbait, 5" Paddle Tail Swimbait, Flutter Spoon 2oz, Flutter Spoon 3oz, 1/4oz Spinnerbait, 3/8oz Spinnerbait, 1/2oz Spinnerbait, 1/4oz Chatterbait, 3/8oz Chatterbait, 1/2oz Chatterbait, 3/4oz Bucktail Jig, 1oz Bucktail Jig, 3/4oz Marabou Jig, 1/8oz Road Runner / Beetle Spin, 1/4oz Road Runner / Beetle Spin, Walking Bait / Spook, Prop Bait / Choppo, Whopper Plopper, Wake Bait
...
Return ONLY valid JSON, no explanation:
{
  ...
  function buildRodFromGroq(lureName, colorName, depth, slotIdx, phaseLabel) {
    ...
    if (lureName?.toLowerCase().includes('a-rig')) {
      const isLight  = lureName.includes('Light')  || lureName.includes('1.65oz');
