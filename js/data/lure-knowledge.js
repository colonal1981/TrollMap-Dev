...
export const LURE_KNOWLEDGE = {
  ...
  crankbait_squarebill: {
    ...
    presentationSignature: { noise:'rattle', flash:'medium', profile:'baitfish', water_column:'upper' }
  },
  ...
  crankbait_mr: {
    ...
    presentationSignature: { noise:'rattle', flash:'medium', profile:'baitfish', water_column:'middle' }
  },
  ...
  crankbait_dd1: {
    ...
    presentationSignature: { noise:'rattle', flash:'medium', profile:'baitfish', water_column:'lower' }
  },
  ...
  lipless: {
    ...
    presentationSignature: { noise:'high_vibe', flash:'medium', profile:'baitfish', water_column:'middle' }
  },
  ...
  umbrella_rig: {
    ...
    presentationSignature: { noise:'high_vibe', flash:'high', profile:'baitfish', water_column:'middle' }
  },
  ...
  swimbait_paddle: {
    ...
    presentationSignature: { noise:'silent', flash:'low', profile:'baitfish', water_column:'middle' }
  },
  ...
  flutter_spoon: {
    ...
    presentationSignature: { noise:'silent', flash:'high', profile:'baitfish', water_column:'lower' }
  },
  ...
  vertical_jig: {
    ...
    presentationSignature: { noise:'silent', flash:'high', profile:'baitfish', water_column:'bottom' }
  },
  ...
  inline_spinner: {
    ...
    presentationSignature: { noise:'high_vibe', flash:'high', profile:'baitfish', water_column:'upper' }
  },
  ...
  bucktail: {
    ...
    presentationSignature: { noise:'silent', flash:'low', profile:'baitfish', water_column:'lower' }
  },
  ...
  marabou_jig: {
    ...
    presentationSignature: { noise:'silent', flash:'none', profile:'baitfish', water_column:'middle' }
  },
  ...
  road_runner: {
    ...
    presentationSignature: { noise:'silent', flash:'medium', profile:'baitfish', water_column:'upper' }
  },
  ...
  topwater_troll: {
    ...
    presentationSignature: { noise:'rattle', flash:'medium', profile:'baitfish', water_column:'surface' }
  },
  ...
  topwater_cast: {
    ...
    presentationSignature: { noise:'rattle', flash:'low', profile:'baitfish', water_column:'surface' }
  },
  ...
  cast_only: {
    ...
    presentationSignature: { noise:'silent', flash:'none', profile:'worm', water_column:'bottom' }
  },
  ...
  underspin: {
    ...
    presentationSignature: { noise:'silent', flash:'medium', profile:'baitfish', water_column:'middle' }
  },
  ...
  jig_football: {
    ...
    presentationSignature: { noise:'silent', flash:'none', profile:'crawfish', water_column:'bottom' }
  },
  ...
  popping_cork: {
    ...
    presentationSignature: { noise:'high_vibe', flash:'low', profile:'shrimp', water_column:'upper' }
  },
};

// ── Scoring engine ────────────────────────────────────────────────────────────
// scoreLureForContext() stood here: a score from species, season, clarity, tactical depth,
// structure and cover fit. Its only caller, selectBestLure() in tackle-inventory.js, was called by
// nothing, and both went on 2026-09-25 -- with getIdealSpeed(), which only its sibling read, and
// the LURE_KNOWLEDGE fields only it read (`species`, `season`, `clarity`, `tacticalDepth`,
// `structure`, and `cover_friendly` in the presentation signature).
