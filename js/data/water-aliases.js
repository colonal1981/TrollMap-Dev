...
export const WATER_ZONE_CANDIDATES = {
  "Intracoastal Waterway": ["coast_murrells_inlet_sc", "coast_cape_romain_sc", "coast_charleston_sc", "coast_santee_delta_sc"],
  "New River": ["coast_savannah_ga"],
  "North River": ["coast_sapelo_altamaha_ga"],
  "Wando River": ["coast_charleston_sc"],
};
